	...
	return (
		<>
			<div className='w-full h-52 md:hidden'>
				<img src={props.images[0]} alt='Restaurant' className='w-full h-full rounded-sm' />
			</div>
			...
			<div className='hidden md:flex w-full h-96 justify-center mt-2 cursor-pointer'>
				...
				<div className='w-1/4 flex flex-col overflow-hidden'>
					<div className='w-full h-full relative mb-1'>
						<img src={props.images[3]} alt='Restaurant' className='w-full h-full rounded-md' />
					...
					<div className='w-full h-full relative'>
						<img src={props.images[4]} alt='Restaurant' className='w-full h-full rounded-md' />
